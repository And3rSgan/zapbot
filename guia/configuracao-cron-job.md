# Configuração do Cron Job — ZapBot

Este guia explica como configurar o cron job utilizado pelo ZapBot para envio automático de lembretes de agendamento via WhatsApp.
