...
const fallback = {
  ...
  sections: [
    { title: "1. Aceitação dos Termos", content: "Ao acessar e utilizar a plataforma ZapBot, você concorda com estes Termos de Uso. Se não concordar com algum dos termos, não utilize nossos serviços." },
    { title: "2. Descrição do Serviço", content: "A ZapBot é uma plataforma de automação e gestão de atendimento via WhatsApp, oferecendo funcionalidades como:\n• Chatbot com inteligência artificial\n• Gestão de conversas e contatos\n• Agendamentos e lembretes automáticos\n• Painel de métricas e relatórios\n• Kanban de acompanhamento" },
    ...
    { title: "6. Propriedade Intelectual", content: "Todo o conteúdo da plataforma, incluindo código-fonte, design, logotipos, textos e funcionalidades, é de propriedade exclusiva da ZapBot e está protegido por leis de propriedade intelectual. É proibida a reprodução, distribuição ou modificação sem autorização prévia." },
    { title: "7. Limitação de Responsabilidade", content: "A ZapBot não se responsabiliza por:\n• Interrupções temporárias no serviço por manutenção ou fatores externos\n• Conteúdo das mensagens enviadas pelos usuários\n• Decisões comerciais tomadas com base nos dados da plataforma\n• Danos indiretos, incidentais ou consequenciais decorrentes do uso do serviço" },
